...
public enum CommandCode {
	...
	COM_SLEEP(0x00), COM_INIT_DB(0x02), COM_QUERY(0x03), COM_FIELD_LIST(0x04),
	COM_QUIT(0x01), COM_PING(0x0e), COM_PREPARE(0x16), COM_EXECUTE(0x17),COM_LONG_DATA(0x18),
	COM_CLOSE_STMT(0x19), COM_RESET_STMT(0x1a)
